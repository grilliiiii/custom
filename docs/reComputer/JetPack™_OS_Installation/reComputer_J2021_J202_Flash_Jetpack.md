...
- [Flashing JetPack OS via NVIDIA SDK Manage](https://wiki.seeedstudio.com/reComputer_J2021_J202_Flash_Jetpack/#flashing-to-emmc-with-command-line)
- [Flashing JetPack OS via Command Line](https://wiki.seeedstudio.com/reComputer_J2021_J202_Flash_Jetpack/#flashing-to-emmc-with-command-line)
