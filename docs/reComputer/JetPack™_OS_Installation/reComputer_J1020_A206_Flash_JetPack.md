...
- [Option 1 - Flashing JetPack OS via NVIDIA SDK Manage](https://wiki.seeedstudio.com/reComputer_J2021_J202_Flash_Jetpack/#flashing-to-emmc-with-command-line)
- [Option 2 - Flashing JetPack OS via Command Line](https://wiki.seeedstudio.com/reComputer_J2021_J202_Flash_Jetpack/#flashing-to-emmc-with-command-line)
